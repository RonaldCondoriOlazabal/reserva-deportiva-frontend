...
@Component({
  ...
  template: `
    <div class="page-header">
      <nav class="breadcrumb">Cliente / <span>Perfil</span></nav>
      <h1 class="page-title">Mi Perfil</h1>
    </div>

    <div class="profile-card card tinted-card">
      <div class="card-body">
  ...
  `,
  styles: [`
    .tinted-card { background: linear-gradient(180deg, #F4F8FA 0%, #E8F0EB 100%); max-width: 480px; margin: 0 auto; }
